              ...
              <div class="col-md-10">
                <form class="form-horizontal" method="post" action="">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="number" name="mkgt1" class="form-control" value="<?= $duk['masa_kerja_golongan'] ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="number" name="mkgt2" class="form-control" value="<?= ($duk['masa_kerja_golongan']) + 2; ?>" required>
                    </div>
                  </div>
